...
FocusScope {
    ...
    */
    ...
    onContentItemChanged: {
        ...
        if (true) //!Settings.hasTouchScreen)
    ...
    children: Item {
        ...
        WheelArea {
            ...
            property int flickThreshold: 5 // Settings.dragThreshold
            ...
            horizontalMaximumValue: flickableItem ? Math.max(horizontalMinimumValue, flickableItem.contentWidth - viewport.width) : 0
            ...
            verticalMaximumValue: flickableItem ? Math.max(verticalMinimumValue, flickableItem.contentHeight - viewport.height + __viewTopMargin) : 0
