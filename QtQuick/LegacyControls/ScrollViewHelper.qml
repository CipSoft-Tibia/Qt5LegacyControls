...
Item {
    ...
    ScrollBarOld {
        ...
        visible: horizontalScrollBarPolicy ==  ScrollBar.AsNeeded ? scrollable : horizontalScrollBarPolicy == ScrollBar.AlwaysOn
    ...
    ScrollBarOld {
        ...
        visible: verticalScrollBarPolicy === ScrollBar.AsNeeded ? scrollable : verticalScrollBarPolicy === ScrollBar.AlwaysOn
