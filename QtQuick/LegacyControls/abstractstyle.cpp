...
void QQuickAbstractStyle1::setPadding(QQuickPadding1 arg)
{
  if (m_padding != arg) {
    m_padding = arg;
    emit paddingChanged();
...
{
  return QQmlListProperty<QObject>(this, 0, &QQuickAbstractStyle1::data_append,
                                   &QQuickAbstractStyle1::data_count, &QQuickAbstractStyle1::data_at,
                                   &QQuickAbstractStyle1::data_clear);
}
